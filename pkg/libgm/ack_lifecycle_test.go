...
type ackRoundTripper func(*http.Request) (*http.Response, error)

func (f ackRoundTripper) RoundTrip(req *http.Request) (*http.Response, error) {
	return f(req)
}
...
func ackTestClient(t *testing.T, handle func(*http.Request, *gmproto.AckMessageRequest) (*http.Response, error)) *Client {
	...
	settings.TransportOverride = func(exhttp.ClientSettings) http.RoundTripper {
		return ackRoundTripper(func(req *http.Request) (*http.Response, error) {
